...
def task_provider_info() -> bool:
    ...
    # Map service types to method names
    service_method_map = {
        "email": "email",
        "sms": "sms",
        "postal": "postal",
    ...
    service_method = service_method_map.get(service_type, service_type)
...
def task_test_providers() -> bool:
    ...
    if method != "check_package_and_config":
        ...
        missive_type = service_to_missive.get(service_type, service_type.upper())
    ...
    if method == "check_package_and_config":
        ...
        print_info(f"Testing {provider_name}.{method_name}() for {missive_type}")
