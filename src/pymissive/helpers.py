...
# Try to import address helpers from geoaddress (preferred)
# Falls back to local implementation if geoaddress not available
try:
    from geoaddress.helpers import (
        describe_address_backends as ga_describe_address_backends,
        get_address_backend_by_attribute as ga_get_address_backend_by_attribute,
        get_address_backends_from_config as ga_get_address_backends_from_config,
        get_address_by_reference as ga_get_address_by_reference,
...
try:
    ...
    # geoaddress not available, use local implementations below
    pass
...
def get_provider_by_attribute(
    ...
    *,
    ...
    Example:
        >>> config = ["pymissive.providers.brevo.BrevoProvider"]
...
def search_addresses(
    ...
    **kwargs: Any,
    ...
    Example:
        >>> config = [{"class": "pymissive.address_backends.nominatim.NominatimAddressBackend", "config": {}}]
...
# =============================================================================
# Export address helpers (use geoaddress versions if available)
# =============================================================================

if _using_geoaddress_helpers:
# Re-export geoaddress functions with original names
describe_address_backends = ga_describe_address_backends
get_address_backend_by_attribute = ga_get_address_backend_by_attribute
get_address_backends_from_config = ga_get_address_backends_from_config
get_address_by_reference = ga_get_address_by_reference
search_addresses = ga_search_addresses
# else: use local implementations defined above
